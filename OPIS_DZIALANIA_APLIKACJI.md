...
Sekcja zaprojektowana na wzór skryptów systemowych (crontab). Służy do zaznaczania swoich dziennych, najważniejszych nawyków prozdrowotnych (poranne nawodnienie, opóźnianie picia kawy o 90 minut, wieczorna dawka suplementów, limit minimalnej dziennej liczby kroków).
...
- Każdy moduł, można otworzyć (rozwijany mechanizm "akordeonu"), odsłaniając jego pełny skład oraz sposób przygotowania (instrukcję/flow).
